---
name: DefectAnalyzer
description: Analyses defect history from context/defect-history.md to identify patterns, root causes, recurring escapes, and high-risk areas for the current banking story
model: copilot
tools:
  - codebase
---
