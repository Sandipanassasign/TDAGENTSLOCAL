---
name: SQLDataGen
description: Generates PCI-DSS compliant SQL INSERT statements with masked sensitive data for all test scenarios derived from context/current-story.md, including boundary, negative, concurrency, and rollback data sets
model: copilot
tools:
  - codebase
---
