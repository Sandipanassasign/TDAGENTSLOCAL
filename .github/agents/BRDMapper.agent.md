---
name: BRDMapper
description: Traces Jira story acceptance criteria back to BRD requirements, produces a traceability matrix, and flags regulatory coverage gaps (RBI, PCI-DSS, NPCI) using context/current-story.md and context/current-brd.md
model: copilot
tools:
  - codebase
---
