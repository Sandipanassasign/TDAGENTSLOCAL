---
name: APITestAgent
description: Generates Postman-compatible API test collections and REST-Assured/Karate scripts for banking APIs covering all HTTP status codes, auth, idempotency, concurrency, and security scenarios from context/current-story.md
model: copilot
tools:
  - codebase
---
